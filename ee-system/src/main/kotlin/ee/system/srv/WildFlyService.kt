...
open class WildFlyService : WildFlyServiceBase {
    ...
    constructor(elName: String = "", category: String = "", dependsOn: MutableList<Service> = arrayListOf(),
        ...
        tool: WildFlyTool = WildFlyTool.EMPTY) : super(elName, category, dependsOn, dependsOnMe, host, port, home,
        config, managementPort, managementUser, managementPassword, defaultParams, tool) {
