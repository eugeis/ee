...
fun Basic.toKotlinImpl(context: KotlinContext, indent: String = "",
    ...
    return """${toKotlinComment(context, indent)}$classDef${primaryConstructor.toKotlinPrimary(context, signatureIndent,
        superUnit)} {
